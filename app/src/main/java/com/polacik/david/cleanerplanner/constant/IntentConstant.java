package com.polacik.david.cleanerplanner.constant;
...
public class IntentConstant {
    ...
    public static final String KEY_CLIENTBEANADDRESS = "KEY_CLIENTBEANADDRESS";
    public static final String KEY_CLIENTBEANPHONE = "KEY_CLIENTBEANPHONE";
    public static final String KEY_CLIENTBEANEMAIL = "KEY_CLIENTBEANEMAIL";
    ...
    public static final String KEY_CALENDARWEEK = "KEY_CALENDARWEEK";
    public static final String KEY_CALENDARYEAR = "KEY_CALENDARYEAR";

    public static final String KEY_PAYMENTSBALANCE = "KEY_PAYMENTSBALANCE";
    public static final String KEY_PAYMENTSTOTAL = "KEY_PAYMENTSTOTAL";
}
